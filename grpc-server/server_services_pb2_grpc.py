...
class SendFileServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendFile = channel.unary_unary(
                '/server_sevices.SendFileService/SendFile',
...
def add_SendFileServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'server_sevices.SendFileService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('server_sevices.SendFileService', rpc_method_handlers)
